...
- ✅ Используется единый сид из admin-panel
...
Вариант А - Запуск единого сида через admin-panel (очистит БД и заполнит тестовыми данными):
...
Убедитесь, что при создании продукта вы создаете записи в таблицах:
